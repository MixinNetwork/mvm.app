<template>
  <div class="flex justify-center items-center pt-[86px] pb-[16px] px-6 eco-background sm:pt-[110px] sm:pb-[154px] sm:px-0">
      ...
      >
        ...
        <div :class="[
          ...
          <div class="flex flex-col justify-center mt-[22px] w-full md:mt-0 lg:w-[528px]">
            ...
            <div class="mt-[22px] font-normal text-base leading-[34px] text-black/90 sm:text-[22px] sm:leading-[38px] lg:mt-6">{{ item.content }}</div>
          </div>
        </div>
      </div>
    </div>
